...
export default function charts({
    ...
    const [filtersMissingPOD, setFiltersMissingPOD] = useState(getFiltersPOD());
    ...
    const [filtersDailyValue, setFiltersDailyReport] = useState(getFiltersDaily());
