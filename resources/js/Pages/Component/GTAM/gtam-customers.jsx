...
export default function GtamCustomers({activeIndex,currentUser,useTypesDb, setActiveIndex,url, employees, setUserProfile, setUserTypeFromPage}) {
    
function createUser(){
    setUserTypeFromPage(1);
    setActiveIndex(6);
}
            ...
            <div className="mt-6 sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    ...
                    <p className="mt-2 text-sm text-gray-700">
                        A list of all the customers in your account including their
