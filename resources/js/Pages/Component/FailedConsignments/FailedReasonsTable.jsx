...
export default function FailedReasonsTable() {
    const { userPermissions, failedReasonsData } = useContext(CustomContext);
        ...
        <div className=" w-full bg-smooth ">
            <div className="sm:flex sm:items-center relative">
                <div className="inline-block sm:absolute left-auto right-0 -top10">
                    {canAddFailedReasons(userPermissions) ? (
                        <button
                            type="button"
