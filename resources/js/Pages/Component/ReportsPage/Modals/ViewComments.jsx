                                ...
                                <div className="flex flex-col gap-4 border-b-1 border-[#D5D5D5] py-3">
                                    <div className="flex pr-2">
                                        ...
                                        {isEditing && editIndx === index
                                            ? <ComboBox idField={"CommentId"} valueField={"Comment"} onChange={onSelectComment} inputValue={comment} options={deliveryCommentsOptions?.length > 0 ? deliveryCommentsOptions?.filter((item) => item.CommentStatus == 1) : []} isMulti={false} onKeyDown={handleKeyDown} setInputValue={setComment}/>
