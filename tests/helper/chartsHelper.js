const calculateStatistics = (data, filteredSafety) => {
    let safetyCounter = 0;
...
module.exports = {calculateStatistics, getConsStatusCounter, getKPIStatusCounter, getStateRecordCounts, getStateTotalWeights, getMonthlyData, getMonthlyRecordCounts, getPODCounts, getPODCountsByState}
