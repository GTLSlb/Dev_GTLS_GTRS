...
describe("Navigation Test", () => {
    ...
    it("user can view the Additional Charges", async () => {
        // Step 1: Navigate to the main page
        await driver.sleep(3000);

        // Step 2: Verify that Additional Charges is displayed
        ...
        assert.strictEqual(
            await title.getText(),
            "Additional Charges",
            "Additional Charges should be displayed."
        );
    });

    for (const { pageName, url } of gtrsPages) {
        it("user can navigate from other pages to the Additional Charges", async () => {
            // Step 1: Navigate to the main page
            await driver.sleep(3000);
            ...
            for (let item of menuItems) {
                ...
                if (text == "Additional Charges") {
                    dashItem = item;
                }
            }

            // Step 3: Navigate to the Additional Charges
...
describe("Table Test", () => {
    const tableFilters = [
        ...
        },
        {
            ...
            locator:
                '//*[@id="app"]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/div[1]/div[3]/div[3]/div[1]/input',
            clearLocator:
                "/html/body/div[1]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div[5]/div/div/div/div/div[1]/div[1]/div[2]/table/tbody/tr[13]",
        },
        {
            ...
            key: "Quantity",
            locator:
                '//*[@id="app"]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/div[1]/div[4]/div[3]/div[1]/input',
            clearLocator:
        ...
        {
            filterName: "Description Ref",
            value: "NRTH CONNEX TOLL",
            key: "DescriptionRef",
            locator:
        ...
        {
            filterName: "Fuel Levy Amount Ref",
            value: 0,
            key: "FuelLevyAmountRef",
            locator:
        ...
        },
        {
            ...
            value: "2024-05-03T12:21:48.303",
            key: "DespatchDateTime",
            locator:
                '//*[@id="app"]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/div[1]/div[9]/div[3]/div[1]/input',
            clearLocator:
                "/html/body/div[1]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div[5]/div/div/div/div/div[1]/div[1]/div[2]/table/tbody/tr[9]",
        },
        {
        ...
        },
        {
            ...
            key: "Code",
            locator:
                '//*[@id="app"]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/div[1]/div[12]/div[3]/div[1]/input',
            clearLocator:
                "/html/body/div[1]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div[5]/div/div/div/div/div[1]/div[1]/div[2]/table/tbody/tr[9]",
        },
    ];
    ...
    it(`Additional Charges data is correct`, async () => {
        try {
            // Step 1: Navigate to the Additional Charges page
            await driver.sleep(2000);
            navigateToPage(driver, "Additional Charges");
            ...
            const apiValues = data.map((addCharge) => {
                return [
                    addCharge.ConsignmentNo,
                    addCharge.SenderReference,
                    addCharge.ReceiverReference,
                    addCharge.Quantity,
                    addCharge.TotalCharge,
                    addCharge.CodeRef,
                    addCharge.DescriptionRef,
                    addCharge.FuelLevyAmountRef,
                    addCharge.DespatchDateTime,
                    addCharge.Name,
                    addCharge.Description,
                    addCharge.Code,
                ];
            });
    ...
    it("user can clear all filters", async () => {
        try {
            // Step 1: Navigate to the Additional Charges page
            await driver.sleep(2000);
            await navigateToPage(driver, "Additional Charges");
...
describe("Table Test", () => {
    ...
    it("user can filter data by debtor account", async () => {
        ...
        const apiValues = filteredAPIData.map((addCharge) => {
            return [
                addCharge.ConsignmentNo,
                addCharge.SenderReference,
                addCharge.ReceiverReference,
