...
describe("Navigation Test", () => {
    ...
    it("user can view the No Delivery info.", async () => {
        // Step 1: Navigate to the main page
        await driver.sleep(3000);

        // Step 2: Verify that No Delivery info. is displayed
        ...
        assert.strictEqual(
            await title.getText(),
            "No Delivery info.",
            "No Delivery info. should be displayed."
        );
    });

    for (const { pageName, url } of gtrsPages) {
        it("user can navigate from other pages to the No Delivery info.", async () => {
            // Step 1: Navigate to the main page
            await driver.sleep(3000);
            ...
            for (let item of menuItems) {
                ...
                if (text == "No Delivery info.") {
                    dashItem = item;
                }
            }

            // Step 3: Navigate to the No Delivery info.
            ...
            assert.strictEqual(
                currentUrl,
                "https://gtrs.gtls.store/gtrs/no-delivery",
                `Expected URL to be 'https://gtrs.gtls.store/gtrs/no-delivery' but got '${currentUrl}'.`
            );
        });
    }
});
...
describe("Table Test", () => {
    const tableFilters = [
        ...
        },
        {
            ...
            value: "2024-05-06T12:07:56.923",
            key: "DespatchDateTime",
            locator:
                '//*[@id="app"]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[3]/div[1]/input',
            clearLocator:
        ...
        },
        {
            ...
            key: "Send_State",
            locator:
                '//*[@id="app"]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/div[1]/div[3]/div[3]/div[4]/div[3]/div[1]/div[1]/span/input',
            clearLocator:
                "/html/body/div[1]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div[5]/div/div/div/div/div[1]/div[1]/div[2]/table/tbody/tr[13]/td",
        },
        {
            filterName: "Status",
            value: "Locked",
            key: "AdminStatusCodes_Description",
            locator:
                '//*[@id="app"]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/div[1]/div[4]/div[3]/div[1]/div[1]/span/input',
            clearLocator:
                "/html/body/div[1]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div[5]/div/div/div/div/div[1]/div[1]/div[2]/table/tbody/tr[9]",
        },
        {
            ...
            key: "ReceiverName",
            locator:
                '//*[@id="app"]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/div[1]/div[5]/div[3]/div[1]/div[3]/div[1]/input',
            clearLocator:
                "/html/body/div[1]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div[5]/div/div/div/div/div[1]/div[1]/div[2]/table/tbody/tr[9]",
        },
        {
            ...
            locator:
                '//*[@id="app"]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/div[1]/div[5]/div[3]/div[2]/div[3]/div[1]/input',
            clearLocator:
                "/html/body/div[1]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div[5]/div/div/div/div/div[1]/div[1]/div[2]/table/tbody/tr[13]/td",
        },
        {
            filterName: "Receiver Suburb",
            value: "EDINBURGH NORTH",
            key: "Del_Suburb",
            locator:
                '//*[@id="app"]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/div[1]/div[5]/div[3]/div[3]/div[3]/div[1]/div[1]/span/input',
            clearLocator:
                "/html/body/div[1]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div[5]/div/div/div/div/div[1]/div[1]/div[2]/table/tbody/tr[9]",
        },
        {
            ...
            key: "Del_State",
            locator:
                '//*[@id="app"]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div/div[1]/div[1]/div[1]/div[1]/div[1]/div[5]/div[3]/div[4]/div[3]/div[1]/div[1]/span/input',
            clearLocator:
                "/html/body/div[1]/div/div/div/div/div[2]/div/div/div/div/main/div[2]/div/div/div/div/div/div[5]/div/div/div/div/div[1]/div[1]/div[2]/table/tbody/tr[9]",
        },
        {
            filterName: "RDD",
            value: "2024-05-09 00:00:00",
    ...
    it(`No Delivery info. data is correct`, async () => {
        try {
            // Step 1: Navigate to the No Delivery info. page
            await driver.sleep(2000);
            navigateToPage(driver, "No Delivery info.");
            ...
            const apiValues = data.map((del) => {
                return [
                    del.ConsignmentNo,
                    del.DespatchDateTime,
                    del.SenderName,
                    del.SenderReference,
                    del.Send_Suburb,
                    del.Send_State,
                    del.AdminStatusCodes_Description,
                    del.ReceiverName,
                    del.ReceiverReference,
                    del.Del_Suburb,
                    del.Del_State,
                    del.DeliveryRequiredDateTime,
                    del.Description,
                ];
            });
    ...
    it("user can clear all filters", async () => {
        try {
            // Step 1: Navigate to the No Delivery info. page
            await driver.sleep(2000);
            await navigateToPage(driver, "No Delivery info.");
...
describe("Table Test", () => {
    ...
    it("user can filter data by debtor account", async () => {
        ...
        const apiValues = filteredAPIData.map((del) => {
            return [
                del.ConsignmentNo,
                del.DespatchDateTime,
                del.SenderName,
    ...
    it("user can navigate to consignment details page", async () => {
        ...
        await consInput.sendKeys("GMI2239");
        ...
        assert.strictEqual(
            consNumber.getText(),
            "GMI2239",
            `Cons number should be GMI2239 but got ${consNumber.getText()}`
        );
    });
});
